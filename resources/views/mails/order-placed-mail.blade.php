                      ...
                      <td align="left" bgcolor="#efefef" style="padding:0;Margin:0;padding-bottom:20px;padding-left:20px;padding-right:20px"> 
                       <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left" role="presentation"> 
                         ...
                         <tr style="border-collapse:collapse"> 
                          ...
                          <td style="padding:0;Margin:0;font-size:14px;line-height:21px">{{date_format($data['order']->created_at->modify( '+10 days' ), "dS M, Y (D)")}}</td> 
                         </tr> 
                         <tr style="border-collapse:collapse"> 
