                ...
                <div class="row"> <!--Buttons Row Start-->
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card text-white bg-primary shadow">
                            <a href="{{route('admin-manage-orders')}}" class="btn btn-primary btn-lg pt-3 pb-3"><b>MANAGE ORDERS</b></a>
                        </div>
                    </div>
                    @endcanany
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card text-white bg-primary shadow">
                            <a href="{{route('admin-manage-products')}}" class="btn btn-primary btn-lg pt-3 pb-3"><b>MANAGE PRODUCTS</b></a>
                        </div>
                    </div>
                    @endcanany
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card text-white bg-primary shadow">
                            <a href="{{route('admin-user-management')}}" class="btn btn-primary btn-lg pt-3 pb-3"><b>USER MANAGEMENT</b></a>
                        </div>
                    </div>
                    @endcanany
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card text-white bg-primary shadow">
                            <a href="{{route('admin-support-tickets')}}" class="btn btn-primary btn-lg pt-3 pb-3"><b>TICKETS</b></a>
                        </div>
                    </div>
                    @endcanany
