...
<h3 class="mb-3">Add Tags & Images</h3>


<div class="container">
    <h5><strong>{{ $product->product_name }}</strong></h5>
       <h6>Tags help improving prduct discovery on search</h6> 
        <p class="mb-4">Enter your tags in the below field, and press <strong>Space</strong> after typing.</p>
        ...
        <form action="{{ route('admin-publish-product-tag-submit') }}" method="POST" id="Form" enctype="multipart/form-data">
            ...
            <button class="btn btn-success float-right bt-lg" type="submit">&nbsp;&nbsp; Next <i class="fa fa-angle-double-right"></i>&nbsp;&nbsp;</button>
        </form>
