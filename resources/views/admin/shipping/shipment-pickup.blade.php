...
@section('modals')
<!-- Modal -->
<div class="modal fade" id="PickupDoneConfirmationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Courier Pickup Confirmation</h5>
...
<div class="container-fluid">
    ...
    <h3>Order Picked Up Confirmation</h3>
            ...
            <div class="account-menu-break"></div>   
                ...
                <div class="wishlist-container ">   
                        ...
                        <div class="account-menu-break"></div>     
                            ...
                            <div class="wishlist-basic-padding">
                                <p>Are you sure, that the order has been picked up by the courier partner? <br></p>
                                <p>If <b>Yes</b>, click the below button to update the Order status as <b>"Order Shipped"</b></p>
                                
                                <button class="btn btn-success" data-toggle="modal" data-target="#PickupDoneConfirmationModal">Pickup Completed <i class="fa fa-check" aria-hidden="true"></i></button>
                            </div>
