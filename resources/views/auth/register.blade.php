                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{route('register')}}">
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-user @error('name') {{ 'is-invalid' }} @enderror" type="text" id="name" name="name" placeholder="Full Name" value="{{old('name')}}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-user @error('email') {{ 'is-invalid' }} @enderror" type="email" id="email" name="email" aria-describedby="emailHelp" placeholder="Email Address" value="{{old('email')}}">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control form-control-user @error('password_confirmation') {{ 'is-invalid' }} @enderror" type="password" id="password_confirmation" name="password_confirmation" placeholder="Repeat Password">
