...
@section('content')
    ...
    <div class="body-container" id="CartContainer">
        ...
        <div class="row">
            ...
            <div class="col-md-9 d-none display-pages-section" id="OrderSummarySection" style="padding-bottom: 45vh;">
                <div class="">
                    <div class="right-wishlist-container"  style="min-height: 80vh;">
                        <div class="">
                            <div class="mt-3 mb-3">
                                <span style="font-size: 16px;">Order Summary</span>
                            </div>
                        </div>
            ...
            <div class="wishlist-container">   
                ...
                @php $StockCounter = 1; @endphp
                                        ...
                                        <div class="row top-bottom-basic-padding" id="CartItem{{ $item->id }}" style="padding-bottom: 0;">
                                            <div class="col-3">
                                            ...
                                            <div class="col-9" style="padding-left: 0;">
                                                <a href="{{route('product-index', $item->id)}}" target="_blank">
                                                    <span class="wish-product-title font-weight-500 color-0066c0 line-limit-3">{{ $item->product_name }}</span>
                                                </a>
...
{{-- Address Section Start --}} 
    <div class="col-md-9 display-pages-section" id="AddressSection" style="padding-bottom: 40vh;">
        <div id="OrderSummaryDIV">
        <div id="addresses-container-div">
            <div class="">
                <div class="">
                    <div class="mt-3 mb-3">
                        <span style="font-size: 16px;">Delivery Address</span>
                    </div>
...
{{-- Payment Section Start --}} 
    <div class="col-md-9 d-none display-pages-section" id="PaymentSection" style="padding-bottom: 45vh;">
            <div class="">
                <div class=" ">
                    <div class="mt-3 mb-3">
                        <span style="font-size: 16px;">Choose Payment Method</span>
                    </div>
