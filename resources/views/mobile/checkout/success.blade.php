            ...
            <div class="right-wishlist-container" style="min-height: 0;">
                ...
                <div class="" style="">
                    <div class="mt-3 mb-3" style="padding-bottom: 0px;">
                        <img src="{{ asset('/img/svg/happy-birth-day.svg') }}" width="40" alt="" srcset="">
                        <span style="padding-right: 0;"> <span style="font-weight: 600;">Order Placed</span></span>     #{{ date_format($data['order']->created_at,"Y-mdHis").'-'.$data['order']->id }}
                    </div>
                </div>
        ...
        <div class="right-wishlist-container" style="min-height: 0;">
            ...
            <div class="wishlist-basic-padding">
                <div class="" style="padding-bottom: 0px;">
                    <div class="row" >
                        <div class="col-6">
                            <span style="font-size: 14px; font-weight: 600;">Delivery Address</span>
                        </div>
                        <div class="col-6">
                            <span style="font-size: 14px; font-weight: 600;">Order Summary</span>
                        </div>
                    </div>
                </div>
            </div>
