...
@section('content')
<div id="DynamicDiv">
    <div class="account-details-container container-fluid">
    
        <div class="right-wishlist-container ">
    
            <div class="mt-3 mb-3">
                <div class="account-details-title" style="padding-bottom: 0px;">
                    <span style="font-size: 16px;">{{ FirstWord(Auth()->user()->name) }}'s Wishlist ({{$wishlistCount}})</span>
                </div>
            </div>
                        ...
                        @foreach ($wishlist->Products as $Product) 
                            ...
                            <div class="row top-bottom-basic-padding" id="WishItem{{ $Product->id }}">
                                ...
                                <div class="col-8" style="padding-right: 0; padding-left: 0;">
                                    <a href="{{ url('product/'.$Product->id) }}" target="_blank">
                                        <span class="wish-product-title font-weight-500 color-0066c0 line-limit-3">{{ $Product->product_name }}</span>
                                    </a>
                                    {{-- Mrp - Price - Dsicount --}}
