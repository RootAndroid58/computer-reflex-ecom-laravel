...
<div class="body-container" id="CartContainer">
    ...
    <div class="container-fluid" style="padding-bottom: 20vh;">
    <div class="row">
    <div class="col-md-9">
    <div class="">
        ...
        <div class="right-wishlist-container"  style="min-height: 80vh;">
            ...
            <div class="mt-3 mb-3">
                <div class="account-details-title" style="padding-bottom: 0px;">
                    <span style="font-size: 16px;">@if (Auth::check()){{ FirstWord(Auth()->user()->name)}}'s @endif Shopping Cart ({{$cart->count()}} @if ($cart->count() > 1)Items @else Item @endif)</span>
                </div>
            </div>
            ...
            <div class="account-menu-break"></div>   
                    ...
                    <div class="wishlist-container">
                        <div class="top-bottom-basic-padding">
                            <div class="w-100"  >
                ...
                <div class="wishlist-container">   
                    ...
                    @php $StockCounter = 1; @endphp
                            ...
                            <div class="row top-bottom-basic-padding" id="CartItem{{ $Product->id }}" style="padding-bottom: 0;">
                                ...
                                <div class="col-md-8 col-8" style="padding-right: 0">
                                    <a href="{{route('product-index', $Product->id)}}" target="_blank">
                                        <span class="line-limit-3 wish-product-title font-weight-500 color-0066c0">{{ $Product->product_name }}</span>
                                    </a>
                            ...
                            <div class="row top-bottom-basic-padding" style="padding-top: 0;"></div>
    ...
    <div class="w-100 bottom-fixed-bar bg-light"  >
        <div class="account-menu-items-container"  style="font-weight: 600; color: black; font-size: 18px; border-top: 1px dashed #e0e0e0; border-bottom: 1px dashed #e0e0e0; margin-bottom: 18px;">
