        ...
        <div class="categori-menu-slider-wrapper clearfix">
            <div class="categories-menu">
                ...
                <div class="category-menu-list">
                    <ul>
                        <li>
                            <a href="#"><img style="width: 20px" src="{{ asset('img/grey.gif') }}" alt="" data-src="{{ asset('ezone/img/icon-img/fan-20.png') }}">Custom Cooling System <i class="pe-7s-angle-right"></i></a>
                ...
                <div class="menu-style-3 menu-hover text-center">
                    <nav>
                        <ul>
                            ...
                            {{-- Brand Store --}}
                            <li><a href="shop.html">BRAND STORE <i class="pe-7s-angle-down"></i> </a>
                                <div class="category-menu-dropdown shop-menu" >
                                    <div class="category-dropdown-style category-common4 mb-30">
                                        <h4 class="categories-subtitle"> shop layout</h4>
                                        <ul>
                            ...
                            {{-- Peripherals --}}
                            <li><a href="shop.html">Peripherals <i class="pe-7s-angle-down"></i> </a>
                                <div class="category-menu-dropdown shop-menu">
                                    <div class="category-dropdown-style category-common4 mb-30">
                                        <h4 class="categories-subtitle"> shop layout</h4>
                                        <ul>
