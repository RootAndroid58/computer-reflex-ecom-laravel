                ...
                <div class="menu-style-3 menu-hover text-center">
                    <nav>
                        <ul>
                            ...
                            <li><a href="shop.html">For Gamers <i class="pe-7s-angle-down"></i> <span class="sticker-new">hot</span></a>
                                <div class="category-menu-dropdown shop-menu" style="left: -200px; width: 1000px;">
                                    <div class="category-dropdown-style category-common4 mb-30">
                            ...
                            {{-- Brand Store --}}
                            <li><a href="shop.html">BRAND STORE <i class="pe-7s-angle-down"></i> <span class="sticker-new">hot</span></a>
                                <div class="category-menu-dropdown shop-menu" style="left: -400px; width: 1000px;">
                                    <div class="category-dropdown-style category-common4 mb-30">
                                        <h4 class="categories-subtitle"> shop layout</h4>
                                        <ul>
                                            <li><a href="shop-grid-2-col.html"> grid 2 column</a></li>
                            ...
                            <li><a href="{{route('support')}}">Laptops</a></li>


                            {{-- Peripherals --}}
                            <li><a href="shop.html">Peripherals <i class="pe-7s-angle-down"></i> <span class="sticker-new">hot</span></a>
                                <div class="category-menu-dropdown shop-menu" style="left: -780px; width: 1000px;">
                                    <div class="category-dropdown-style category-common4 mb-30">
                                        <h4 class="categories-subtitle"> shop layout</h4>
                                        <ul>
                                            <li><a href="shop-grid-2-col.html"> grid 2 column</a></li>
