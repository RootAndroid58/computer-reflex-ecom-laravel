...
Breadcrumbs::for('admin-support-tickets', function ($trail) {
    $trail->parent('admin-dashboard');
    $trail->push('Support Tickets', route('admin-support-tickets'));
});
...
Breadcrumbs::for('admin-manage-banners', function ($trail) {
    $trail->parent('admin-manage-ui');
    $trail->push('Carousel Sliders', route('admin-manage-banners'));
});
